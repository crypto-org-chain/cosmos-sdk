...
// QueryValidatorQueueRequest is request type for Query/ValidatorQueue RPC method.
type QueryValidatorQueueRequest struct {
	// pagination defines an optional pagination for the request.
	Pagination *query.PageRequest `protobuf:"bytes,1,opt,name=pagination,proto3" json:"pagination,omitempty"`
}

func (m *QueryValidatorQueueRequest) Reset()         { *m = QueryValidatorQueueRequest{} }
func (m *QueryValidatorQueueRequest) String() string { return proto.CompactTextString(m) }
func (*QueryValidatorQueueRequest) ProtoMessage()    {}
func (*QueryValidatorQueueRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_f270127f442bbcd8, []int{28}
}
func (m *QueryValidatorQueueRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryValidatorQueueRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryValidatorQueueRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryValidatorQueueRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryValidatorQueueRequest.Merge(m, src)
}
func (m *QueryValidatorQueueRequest) XXX_Size() int {
	return m.Size()
}
func (m *QueryValidatorQueueRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryValidatorQueueRequest.DiscardUnknown(m)
}

var xxx_messageInfo_QueryValidatorQueueRequest proto.InternalMessageInfo

func (m *QueryValidatorQueueRequest) GetPagination() *query.PageRequest {
	if m != nil {
		return m.Pagination
	}
	return nil
...
// ValidatorQueueEntry represents a single entry in the validator queue
type ValidatorQueueEntry struct {
	// unbonding_time is when these validators will finish unbonding
	UnbondingTime time.Time `protobuf:"bytes,1,opt,name=unbonding_time,json=unbondingTime,proto3,stdtime" json:"unbonding_time"`
	// unbonding_height is the block height when unbonding completes
	...
	// validator_addresses are the validators that unbond at this time/height
...
func (m *ValidatorQueueEntry) Reset()         { *m = ValidatorQueueEntry{} }
func (m *ValidatorQueueEntry) String() string { return proto.CompactTextString(m) }
func (*ValidatorQueueEntry) ProtoMessage()    {}
func (*ValidatorQueueEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_f270127f442bbcd8, []int{29}
}
func (m *ValidatorQueueEntry) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ValidatorQueueEntry) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ValidatorQueueEntry.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ValidatorQueueEntry) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ValidatorQueueEntry.Merge(m, src)
}
func (m *ValidatorQueueEntry) XXX_Size() int {
	return m.Size()
}
func (m *ValidatorQueueEntry) XXX_DiscardUnknown() {
	xxx_messageInfo_ValidatorQueueEntry.DiscardUnknown(m)
}

var xxx_messageInfo_ValidatorQueueEntry proto.InternalMessageInfo

func (m *ValidatorQueueEntry) GetUnbondingTime() time.Time {
	if m != nil {
...
func (m *ValidatorQueueEntry) GetUnbondingHeight() int64 {
	if m != nil {
...
func (m *ValidatorQueueEntry) GetValidatorAddresses() []string {
	if m != nil {
...
// QueryValidatorQueueResponse is response type for the Query/ValidatorQueue RPC method.
type QueryValidatorQueueResponse struct {
	// entries contains the validator queue entries
	Entries []ValidatorQueueEntry `protobuf:"bytes,1,rep,name=entries,proto3" json:"entries"`
	// pagination defines the pagination in the response.
	Pagination *query.PageResponse `protobuf:"bytes,2,opt,name=pagination,proto3" json:"pagination,omitempty"`
	// total_count is the total number of entries in the queue
	TotalCount uint64 `protobuf:"varint,3,opt,name=total_count,json=totalCount,proto3" json:"total_count,omitempty"`
	// total_validators is the total number of validators across all entries
	TotalValidators uint64 `protobuf:"varint,4,opt,name=total_validators,json=totalValidators,proto3" json:"total_validators,omitempty"`
}

func (m *QueryValidatorQueueResponse) Reset()         { *m = QueryValidatorQueueResponse{} }
func (m *QueryValidatorQueueResponse) String() string { return proto.CompactTextString(m) }
func (*QueryValidatorQueueResponse) ProtoMessage()    {}
func (*QueryValidatorQueueResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_f270127f442bbcd8, []int{30}
}
func (m *QueryValidatorQueueResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryValidatorQueueResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryValidatorQueueResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryValidatorQueueResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryValidatorQueueResponse.Merge(m, src)
}
func (m *QueryValidatorQueueResponse) XXX_Size() int {
	return m.Size()
}
func (m *QueryValidatorQueueResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryValidatorQueueResponse.DiscardUnknown(m)
}

var xxx_messageInfo_QueryValidatorQueueResponse proto.InternalMessageInfo

func (m *QueryValidatorQueueResponse) GetEntries() []ValidatorQueueEntry {
	if m != nil {
		return m.Entries
	}
	return nil
...
func (m *QueryValidatorQueueResponse) GetPagination() *query.PageResponse {
	if m != nil {
		return m.Pagination
	}
	return nil
...
func (m *QueryValidatorQueueResponse) GetTotalCount() uint64 {
	if m != nil {
		return m.TotalCount
	}
	return 0
...
func (m *QueryValidatorQueueResponse) GetTotalValidators() uint64 {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*QueryValidatorQueueRequest)(nil), "cosmos.staking.v1beta1.QueryValidatorQueueRequest")
	proto.RegisterType((*ValidatorQueueEntry)(nil), "cosmos.staking.v1beta1.ValidatorQueueEntry")
	proto.RegisterType((*QueryValidatorQueueResponse)(nil), "cosmos.staking.v1beta1.QueryValidatorQueueResponse")
}
...
var fileDescriptor_f270127f442bbcd8 = []byte{
	...
	,
}
...
type QueryClient interface {
	...
	// ValidatorQueue queries the validator unbonding queue for debugging.
	ValidatorQueue(ctx context.Context, in *QueryValidatorQueueRequest, opts ...grpc.CallOption) (*QueryValidatorQueueResponse, error)
}
...
func (c *queryClient) ValidatorQueue(ctx context.Context, in *QueryValidatorQueueRequest, opts ...grpc.CallOption) (*QueryValidatorQueueResponse, error) {
	out := new(QueryValidatorQueueResponse)
	err := c.cc.Invoke(ctx, "/cosmos.staking.v1beta1.Query/ValidatorQueue", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type QueryServer interface {
	...
	// ValidatorQueue queries the validator unbonding queue for debugging.
	ValidatorQueue(context.Context, *QueryValidatorQueueRequest) (*QueryValidatorQueueResponse, error)
}
...
func (*UnimplementedQueryServer) ValidatorQueue(ctx context.Context, req *QueryValidatorQueueRequest) (*QueryValidatorQueueResponse, error) {
...
func _Query_ValidatorQueue_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QueryValidatorQueueRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QueryServer).ValidatorQueue(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cosmos.staking.v1beta1.Query/ValidatorQueue",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueryServer).ValidatorQueue(ctx, req.(*QueryValidatorQueueRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Query_ValidatorQueue_Handler,
		},
	},
...
func (m *QueryValidatorQueueRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryValidatorQueueRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryValidatorQueueRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ValidatorQueueEntry) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ValidatorQueueEntry) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ValidatorQueueEntry) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.UnbondingHeight != 0 {
		i = encodeVarintQuery(dAtA, i, uint64(m.UnbondingHeight))
		i--
		dAtA[i] = 0x10
	}
	n23, err23 := github_com_cosmos_gogoproto_types.StdTimeMarshalTo(m.UnbondingTime, dAtA[i-github_com_cosmos_gogoproto_types.SizeOfStdTime(m.UnbondingTime):])
	if err23 != nil {
		return 0, err23
	}
	i -= n23
...
func (m *QueryValidatorQueueResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryValidatorQueueResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryValidatorQueueResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryValidatorQueueRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ValidatorQueueEntry) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	n += 1 + l + sovQuery(uint64(l))
	if m.UnbondingHeight != 0 {
		n += 1 + sovQuery(uint64(m.UnbondingHeight))
	}
	if len(m.ValidatorAddresses) > 0 {
...
func (m *QueryValidatorQueueResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryValidatorQueueRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryValidatorQueueRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryValidatorQueueRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *ValidatorQueueEntry) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ValidatorQueueEntry: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ValidatorQueueEntry: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *QueryValidatorQueueResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryValidatorQueueResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryValidatorQueueResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Entries = append(m.Entries, ValidatorQueueEntry{})
