...
func (x *fastReflection_Metadata) ProtoMethods() *protoiface.Methods {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 1:
				if wireType != 0 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field IsDirty", wireType)
				}
				var v int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
			...
			case 2:
				if wireType != 0 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field IsFull", wireType)
				}
				var v int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
...
var File_cosmos_staking_v1beta1_cache_proto protoreflect.FileDescriptor

var file_cosmos_staking_v1beta1_cache_proto_rawDesc = []byte{
	0x0a, 0x22, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2f, 0x73, 0x74, 0x61, 0x6b, 0x69, 0x6e, 0x67,
	0x2f, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2f, 0x63, 0x61, 0x63, 0x68, 0x65, 0x2e, 0x70,
...
var (
	file_cosmos_staking_v1beta1_cache_proto_rawDescOnce sync.Once
	file_cosmos_staking_v1beta1_cache_proto_rawDescData = file_cosmos_staking_v1beta1_cache_proto_rawDesc
)

func file_cosmos_staking_v1beta1_cache_proto_rawDescGZIP() []byte {
	file_cosmos_staking_v1beta1_cache_proto_rawDescOnce.Do(func() {
		file_cosmos_staking_v1beta1_cache_proto_rawDescData = protoimpl.X.CompressGZIP(file_cosmos_staking_v1beta1_cache_proto_rawDescData)
	})
	return file_cosmos_staking_v1beta1_cache_proto_rawDescData
}
...
func init() { file_cosmos_staking_v1beta1_cache_proto_init() }
func file_cosmos_staking_v1beta1_cache_proto_init() {
	if File_cosmos_staking_v1beta1_cache_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_cosmos_staking_v1beta1_cache_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_cosmos_staking_v1beta1_cache_proto_goTypes,
		DependencyIndexes: file_cosmos_staking_v1beta1_cache_proto_depIdxs,
		MessageInfos:      file_cosmos_staking_v1beta1_cache_proto_msgTypes,
	}.Build()
	File_cosmos_staking_v1beta1_cache_proto = out.File
	file_cosmos_staking_v1beta1_cache_proto_rawDesc = nil
	file_cosmos_staking_v1beta1_cache_proto_goTypes = nil
	file_cosmos_staking_v1beta1_cache_proto_depIdxs = nil
}
