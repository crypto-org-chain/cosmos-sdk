...
var (
	md_QueueLastProcessedState           protoreflect.MessageDescriptor
	fd_QueueLastProcessedState_height    protoreflect.FieldDescriptor
	fd_QueueLastProcessedState_timestamp protoreflect.FieldDescriptor
)

func init() {
	file_cosmos_staking_v1beta1_staking_proto_init()
	md_QueueLastProcessedState = File_cosmos_staking_v1beta1_staking_proto.Messages().ByName("QueueLastProcessedState")
	fd_QueueLastProcessedState_height = md_QueueLastProcessedState.Fields().ByName("height")
	fd_QueueLastProcessedState_timestamp = md_QueueLastProcessedState.Fields().ByName("timestamp")
}

var _ protoreflect.Message = (*fastReflection_QueueLastProcessedState)(nil)

type fastReflection_QueueLastProcessedState QueueLastProcessedState

func (x *QueueLastProcessedState) ProtoReflect() protoreflect.Message {
	return (*fastReflection_QueueLastProcessedState)(x)
}

func (x *QueueLastProcessedState) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_QueueLastProcessedState_messageType fastReflection_QueueLastProcessedState_messageType
var _ protoreflect.MessageType = fastReflection_QueueLastProcessedState_messageType{}

type fastReflection_QueueLastProcessedState_messageType struct{}

func (x fastReflection_QueueLastProcessedState_messageType) Zero() protoreflect.Message {
	return (*fastReflection_QueueLastProcessedState)(nil)
}
func (x fastReflection_QueueLastProcessedState_messageType) New() protoreflect.Message {
	return new(fastReflection_QueueLastProcessedState)
}
func (x fastReflection_QueueLastProcessedState_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_QueueLastProcessedState
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_QueueLastProcessedState) Descriptor() protoreflect.MessageDescriptor {
	return md_QueueLastProcessedState
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_QueueLastProcessedState) Type() protoreflect.MessageType {
	return _fastReflection_QueueLastProcessedState_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_QueueLastProcessedState) New() protoreflect.Message {
	return new(fastReflection_QueueLastProcessedState)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_QueueLastProcessedState) Interface() protoreflect.ProtoMessage {
	return (*QueueLastProcessedState)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_QueueLastProcessedState) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Height != uint64(0) {
		value := protoreflect.ValueOfUint64(x.Height)
		if !f(fd_QueueLastProcessedState_height, value) {
			return
		}
	}
	if x.Timestamp != nil {
		value := protoreflect.ValueOfMessage(x.Timestamp.ProtoReflect())
		if !f(fd_QueueLastProcessedState_timestamp, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_QueueLastProcessedState) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.staking.v1beta1.QueueLastProcessedState.height":
		return x.Height != uint64(0)
	case "cosmos.staking.v1beta1.QueueLastProcessedState.timestamp":
		return x.Timestamp != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.staking.v1beta1.QueueLastProcessedState"))
		}
		panic(fmt.Errorf("message cosmos.staking.v1beta1.QueueLastProcessedState does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueueLastProcessedState) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "cosmos.staking.v1beta1.QueueLastProcessedState.height":
		x.Height = uint64(0)
	case "cosmos.staking.v1beta1.QueueLastProcessedState.timestamp":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_QueueLastProcessedState) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "cosmos.staking.v1beta1.QueueLastProcessedState.height":
		value := x.Height
		return protoreflect.ValueOfUint64(value)
	...
	default:
		...
		panic(fmt.Errorf("message cosmos.staking.v1beta1.QueueLastProcessedState does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueueLastProcessedState) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "cosmos.staking.v1beta1.QueueLastProcessedState.height":
		x.Height = value.Uint()
	case "cosmos.staking.v1beta1.QueueLastProcessedState.timestamp":
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueueLastProcessedState) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.staking.v1beta1.QueueLastProcessedState.timestamp":
		if x.Timestamp == nil {
	...
	case "cosmos.staking.v1beta1.QueueLastProcessedState.height":
		panic(fmt.Errorf("field height of message cosmos.staking.v1beta1.QueueLastProcessedState is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.staking.v1beta1.QueueLastProcessedState"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_QueueLastProcessedState) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.staking.v1beta1.QueueLastProcessedState.height":
		return protoreflect.ValueOfUint64(uint64(0))
	case "cosmos.staking.v1beta1.QueueLastProcessedState.timestamp":
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_QueueLastProcessedState) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.staking.v1beta1.QueueLastProcessedState", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_QueueLastProcessedState) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueueLastProcessedState) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_QueueLastProcessedState) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_QueueLastProcessedState) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*QueueLastProcessedState)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueueLastProcessedState: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueueLastProcessedState: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 0 {
...
func (x *QueueLastProcessedState) Reset() {
	*x = QueueLastProcessedState{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cosmos_staking_v1beta1_staking_proto_msgTypes[21]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *QueueLastProcessedState) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueueLastProcessedState) ProtoMessage() {}

// Deprecated: Use QueueLastProcessedState.ProtoReflect.Descriptor instead.
func (*QueueLastProcessedState) Descriptor() ([]byte, []int) {
	return file_cosmos_staking_v1beta1_staking_proto_rawDescGZIP(), []int{21}
}

func (x *QueueLastProcessedState) GetHeight() uint64 {
	if x != nil {
		return x.Height
	}
	return 0
...
func (x *QueueLastProcessedState) GetTimestamp() *timestamppb.Timestamp {
	if x != nil {
		return x.Timestamp
	}
	return nil
...
var file_cosmos_staking_v1beta1_staking_proto_rawDesc = []byte{
	...
	0xa0, 0x1f, 0x00, 0xe8, 0xa0, 0x1f, 0x00, 0x22, 0x9f, 0x03, 0x0a, 0x18, 0x55, 0x6e, 0x62, 0x6f,
	...
	0x73, 0x2e, 0x49, 0x6e, 0x74, 0x52, 0x07, 0x62, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x12, 0x25,
	0x0a, 0x0c, 0x75, 0x6e, 0x62, 0x6f, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x5f, 0x69, 0x64, 0x18, 0x05,
	0x20, 0x01, 0x28, 0x04, 0x42, 0x02, 0x18, 0x01, 0x52, 0x0b, 0x75, 0x6e, 0x62, 0x6f, 0x6e, 0x64,
	...
	,
...
var file_cosmos_staking_v1beta1_staking_proto_goTypes = []interface{}{
	...
	(*QueueLastProcessedState)(nil),   // 23: cosmos.staking.v1beta1.QueueLastProcessedState
...
var file_cosmos_staking_v1beta1_staking_proto_depIdxs = []int32{
	...
	25, // 22: cosmos.staking.v1beta1.QueueLastProcessedState.timestamp:type_name -> google.protobuf.Timestamp
...
func file_cosmos_staking_v1beta1_staking_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_cosmos_staking_v1beta1_staking_proto_msgTypes[21].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueueLastProcessedState); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
